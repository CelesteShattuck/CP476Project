...
1 for the games
1 for user lives, as a new socket may not work, it can have general lives, and current board
The program will check the database every so often for updates
This is not efficent, but does get the job done
*/